...
import { type ToastProps as HookToastProps, type ToastActionElement as HookToastActionElement } from "@/hooks/use-toast";
...
type ToastProps = HookToastProps;
type ToastActionElement = HookToastActionElement;
